...
Blockly.Blocks['easykb_setuppin'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["4","4"], ["13","13"], ["21","21"], ["22","22"],["23","23"],["25","25"]]), "PINIO")
...
Blockly.Blocks['easykb_writeio'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["4","4"], ["13","13"], ["21","21"], ["22","22"],["23","23"],["25","25"]]), "EasyKB WriteIOPIN")
        this.appendDummyInput()
        .appendField("to")
...
Blockly.Blocks['easykb_readio'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["4","4"], ["13","13"], ["21","21"], ["22","22"],["23","23"],["25","25"]]), "PINReadIO");
    this.setInputsInline(true);
...
Blockly.Blocks['easykb_readadc'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["26","26"],["27","27"], ["32","32"], ["33","33"], ["34","34"], ["35","35"], ["36","36"], ["39","39"]]), "PINADC");
    this.setInputsInline(true);
    this.setOutput(true, "Number");
    this.setColour(150);
 this.setTooltip("");
...
Blockly.Blocks['easykb_sw'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("EasyKids: WaitForStart Pin")
        .appendField(new Blockly.FieldDropdown([["4","4"], ["13","13"], ["21","21"], ["22","22"],["23","23"],["25","25"]]), "swpin");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(90);
...
Blockly.Blocks['easykb_servo'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["14","14"], ["15","15"],]), "pin");
    this.appendValueInput("value")
        .setCheck("Number")
        .appendField("value");
    this.appendDummyInput()
